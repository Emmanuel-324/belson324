...
#ifndef MATREACTION_ABSCOUPLE_H
#define MATREACTION_ABSCOUPLE_H
 ...
 */
class MatReaction_abscouple : public DerivativeMaterialInterface<JvarMapKernelInterface<Kernel>>
{
public:
  MatReaction_abscouple(const InputParameters & parameters);
