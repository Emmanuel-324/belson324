...
class CrystalPlasticityKalidindiUpdate_slip;

/**
 * CrystalPlasticityKalidindiUpdate_slip uses the multiplicative decomposition of the
...
class CrystalPlasticityKalidindiUpdate_slip : public CrystalPlasticityStressUpdateBase_abs
{
public:
  static InputParameters validParams();

  CrystalPlasticityKalidindiUpdate_slip(const InputParameters & parameters);
