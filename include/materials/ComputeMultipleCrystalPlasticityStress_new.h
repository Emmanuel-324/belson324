...
/**
 * ComputeMultipleCrystalPlasticityStress_new (used together with CrystalPlasticityStressUpdateBase)
 ...
 */
class ComputeMultipleCrystalPlasticityStress_new : public ComputeFiniteStrainElasticStress
{
public:
  static InputParameters validParams();

  ComputeMultipleCrystalPlasticityStress_new(const InputParameters & parameters);
