...
class CrystalPlasticityStressUpdateBase_abs1 : public Material
{
public:
  static InputParameters validParams();

  CrystalPlasticityStressUpdateBase_abs1(const InputParameters & parameters);
  ...
  // Declaration of method for transforming DO22 slip systems 
  
  void transformDO22SlipSystems(const MooseUtils::DelimitedFileReader & reader);
...
protected:
  ...
  enum class CrystalLatticeType { BCC, FCC, HCP, DO22 };

  const CrystalLatticeType _crystal_lattice_type;
