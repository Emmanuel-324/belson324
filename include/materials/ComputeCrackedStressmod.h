 ...
 */
class ComputeCrackedStressmod : public DerivativeMaterialInterface<Material>
{
public:
  static InputParameters validParams();

  ComputeCrackedStressmod(const InputParameters & parameters);
...
protected:
  ...
  const MaterialProperty<Real> & _dhdc;

  /// Second-order derivative of degradation w.r.t damage variable                             
  const MaterialProperty<Real> & _d2hdc2;
