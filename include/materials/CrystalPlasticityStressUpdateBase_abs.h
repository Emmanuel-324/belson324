...
class CrystalPlasticityStressUpdateBase_abs : public Material
{
public:
  static InputParameters validParams();

  CrystalPlasticityStressUpdateBase_abs(const InputParameters & parameters);
...
protected:
  ...
  const enum class CrystalLatticeType { BCC, FCC, HCP, DO22 } _crystal_lattice_type;
