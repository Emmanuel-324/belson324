...
/**
 * ComputeCrystalPlasticityEigenstrainBase_abs is the base class for computing eigenstrain tensors in
 * crystal plasticity models
 */
class ComputeCrystalPlasticityEigenstrainBase_abs : public ComputeEigenstrainBase
{
public:
  static InputParameters validParams();

  ComputeCrystalPlasticityEigenstrainBase_abs(const InputParameters & parameters);
