...
/**
 * SwitchingFunctionMultiPhaseMaterial_abs1 is a switching function for a multi-phase,
 ...
 */
template <bool is_ad>
class SwitchingFunctionMultiPhaseMaterial_abs1Templ : public DerivativeMaterialInterface<Material>
{
public:
  static InputParameters validParams();

  SwitchingFunctionMultiPhaseMaterial_abs1Templ(const InputParameters & parameters);
...
typedef SwitchingFunctionMultiPhaseMaterial_abs1Templ<false> SwitchingFunctionMultiPhaseMaterial_abs1;
typedef SwitchingFunctionMultiPhaseMaterial_abs1Templ<true> ADSwitchingFunctionMultiPhaseMaterial_abs1;
