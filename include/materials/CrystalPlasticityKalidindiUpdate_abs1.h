...
class CrystalPlasticityKalidindiUpdate_abs1 : public CrystalPlasticityStressUpdateBase_abs1
{
public:
  static InputParameters validParams();

  CrystalPlasticityKalidindiUpdate_abs1(const InputParameters & parameters);
...
protected:
  ...
  // --- Backstress substepping cache (mirror slip_resistance logic) ---
