...
class CrystalPlasticityKalidindiUpdate_slip_new;

/**
 * CrystalPlasticityKalidindiUpdate_slip_new uses the multiplicative decomposition of the
...
class CrystalPlasticityKalidindiUpdate_slip_new : public CrystalPlasticityStressUpdateBase_abs
{
public:
  static InputParameters validParams();

  CrystalPlasticityKalidindiUpdate_slip_new(const InputParameters & parameters);
...
protected:
  ...
  /// Hardening constants for each slip system mode
  const std::vector<Real> _h_per_mode;

  /// Hardening coefficient for each slip system mode
  const std::vector<Real> _gss_a_per_mode;

  /// Saturated slip system strength for each slip system mode
  const std::vector<Real> _t_sat_per_mode;
