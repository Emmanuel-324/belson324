 ...
 */
class ComputeMultipleCrystalPlasticityStress_abs : public ComputeFiniteStrainElasticStress
{
public:
  static InputParameters validParams();

  ComputeMultipleCrystalPlasticityStress_abs(const InputParameters & parameters);
