...
registerMooseObject("belson324App", ComputeMultipleCrystalPlasticityStress_new);

InputParameters
ComputeMultipleCrystalPlasticityStress_new::validParams()
{
...
ComputeMultipleCrystalPlasticityStress_new::ComputeMultipleCrystalPlasticityStress_new(
...
void
ComputeMultipleCrystalPlasticityStress_new::initQpStatefulProperties()
{
...
void
ComputeMultipleCrystalPlasticityStress_new::initialSetup()
{
...
void
ComputeMultipleCrystalPlasticityStress_new::computeQpStress()
{
  for (unsigned int i = 0; i < _num_models; ++i)
  {
    _models[i]->setQp(_qp);
...
void
ComputeMultipleCrystalPlasticityStress_new::updateStress(RankTwoTensor & cauchy_stress,
                                                     RankFourTensor & jacobian_mult)
{
  ...
  do
  {
    ...
    if (substep_iter > _max_substep_iter && _convergence_failed)
      mooseException("ComputeMultipleCrystalPlasticityStress_new: Constitutive failure");
...
void
ComputeMultipleCrystalPlasticityStress_new::preSolveQp()
{
  for (unsigned int i = 0; i < _num_models; ++i)
...
void
ComputeMultipleCrystalPlasticityStress_new::solveQp()
{
  for (unsigned int i = 0; i < _num_models; ++i)
  {
...
void
ComputeMultipleCrystalPlasticityStress_new::postSolveQp(RankTwoTensor & cauchy_stress,
                                                    RankFourTensor & jacobian_mult)
{
...
void
ComputeMultipleCrystalPlasticityStress_new::solveStateVariables()
{
  ...
  do
  {
    ...
    {
      if (_print_convergence_message)
        mooseWarning("ComputeMultipleCrystalPlasticityStress_new: State variables (or the system "
  ...
  if (iteration == _maxiterg)
  {
    if (_print_convergence_message)
      mooseWarning(
          "ComputeMultipleCrystalPlasticityStress_new: Hardness Integration error. Reached the "
...
void
ComputeMultipleCrystalPlasticityStress_new::solveStress()
{
  ...
  {
    if (_print_convergence_message)
      mooseWarning("ComputeMultipleCrystalPlasticityStress_new: the slip increment exceeds tolerance "
                   "at element ",
                   _current_elem->id(),
                   " and Gauss point ",
                   _qp);
  ...
  while (rnorm > _rtol * rnorm0 && rnorm > _abs_tol && iteration < _maxiter)
  {
    ...
    {
      if (_print_convergence_message)
        mooseWarning("ComputeMultipleCrystalPlasticityStress_new: Failed with line search");
  ...
  {
    if (_print_convergence_message)
      mooseWarning("ComputeMultipleCrystalPlasticityStress_new: Stress Integration error rmax = ",
                   rnorm,
...
void
ComputeMultipleCrystalPlasticityStress_new::calculateResidualAndJacobian()
{
  calculateResidual();
  if (_convergence_failed)
    return;
...
void
ComputeMultipleCrystalPlasticityStress_new::calculateResidual()
{
...
void
ComputeMultipleCrystalPlasticityStress_new::calculateJacobian()
{
...
void
ComputeMultipleCrystalPlasticityStress_new::calcTangentModuli(RankFourTensor & jacobian_mult)
{
...
void
ComputeMultipleCrystalPlasticityStress_new::elastoPlasticTangentModuli(RankFourTensor & jacobian_mult)
{
...
void
ComputeMultipleCrystalPlasticityStress_new::elasticTangentModuli(RankFourTensor & jacobian_mult)
{
...
bool
ComputeMultipleCrystalPlasticityStress_new::lineSearchUpdate(const Real & rnorm_prev,
...
void
ComputeMultipleCrystalPlasticityStress_new::calculateEigenstrainDeformationGrad()
{
  _inverse_eigenstrain_deformation_grad.zero();
  _inverse_eigenstrain_deformation_grad.addIa(1.0);
