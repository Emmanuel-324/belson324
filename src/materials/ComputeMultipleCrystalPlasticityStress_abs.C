...
registerMooseObject("belson324App", ComputeMultipleCrystalPlasticityStress_abs);

InputParameters
ComputeMultipleCrystalPlasticityStress_abs::validParams()
{
...
ComputeMultipleCrystalPlasticityStress_abs::ComputeMultipleCrystalPlasticityStress_abs(
  ...
  : ComputeFiniteStrainElasticStress(parameters),
    ...
    _total_lagrangian_strain(
        declareProperty<RankTwoTensor>(_base_name + "total_lagrangian_strain")), // Lagrangian strain
...
void
ComputeMultipleCrystalPlasticityStress_abs::initQpStatefulProperties()
{
...
void
ComputeMultipleCrystalPlasticityStress_abs::initialSetup()
{
  ...
  for (unsigned int i = 0; i < _num_models; ++i)
  {
    ...
    if (model)
    {
      ...
      mooseError("Model " + model_names[i] +
                 " is not compatible with ComputeMultipleCrystalPlasticityStress_abs");
  }
...
void
ComputeMultipleCrystalPlasticityStress_abs::computeQpStress()
{
  for (unsigned int i = 0; i < _num_models; ++i)
  {
    _models[i]->setQp(_qp);
...
void
ComputeMultipleCrystalPlasticityStress_abs::updateStress(RankTwoTensor & cauchy_stress,
                                                     RankFourTensor & jacobian_mult)
{
  ...
  do
  {
    ...
    if (substep_iter > _max_substep_iter && _convergence_failed)
      mooseException("ComputeMultipleCrystalPlasticityStress_abs: Constitutive failure");
...
void
ComputeMultipleCrystalPlasticityStress_abs::preSolveQp()
{
  for (unsigned int i = 0; i < _num_models; ++i)
...
void
ComputeMultipleCrystalPlasticityStress_abs::solveQp()
{
  for (unsigned int i = 0; i < _num_models; ++i)
  {
...
void
ComputeMultipleCrystalPlasticityStress_abs::postSolveQp(RankTwoTensor & cauchy_stress,
                                                    RankFourTensor & jacobian_mult)
{
...
void
ComputeMultipleCrystalPlasticityStress_abs::solveStateVariables()
{
  ...
  do
  {
    ...
    {
      if (_print_convergence_message)
        mooseWarning("ComputeMultipleCrystalPlasticityStress_abs: State variables (or the system "
  ...
  if (iteration == _maxiterg)
  {
    if (_print_convergence_message)
      mooseWarning(
          "ComputeMultipleCrystalPlasticityStress_abs: Hardness Integration error. Reached the "
...
void
ComputeMultipleCrystalPlasticityStress_abs::solveStress()
{
  ...
  {
    if (_print_convergence_message)
      mooseWarning("ComputeMultipleCrystalPlasticityStress_abs: the slip increment exceeds tolerance "
                   "at element ",
                   _current_elem->id(),
                   " and Gauss point ",
                   _qp);
  ...
  while (rnorm > _rtol * rnorm0 && rnorm > _abs_tol && iteration < _maxiter)
  {
    ...
    {
      if (_print_convergence_message)
        mooseWarning("ComputeMultipleCrystalPlasticityStress_abs: Failed with line search");
  ...
  {
    if (_print_convergence_message)
      mooseWarning("ComputeMultipleCrystalPlasticityStress_abs: Stress Integration error rmax = ",
                   rnorm,
...
void
ComputeMultipleCrystalPlasticityStress_abs::calculateResidualAndJacobian()
{
  calculateResidual();
  if (_convergence_failed)
    return;
...
void
ComputeMultipleCrystalPlasticityStress_abs::calculateResidual()
{
...
void
ComputeMultipleCrystalPlasticityStress_abs::calculateJacobian()
{
...
void
ComputeMultipleCrystalPlasticityStress_abs::calcTangentModuli(RankFourTensor & jacobian_mult)
{
...
void
ComputeMultipleCrystalPlasticityStress_abs::elastoPlasticTangentModuli(RankFourTensor & jacobian_mult)
{
...
void
ComputeMultipleCrystalPlasticityStress_abs::elasticTangentModuli(RankFourTensor & jacobian_mult)
{
...
bool
ComputeMultipleCrystalPlasticityStress_abs::lineSearchUpdate(const Real & rnorm_prev,
...
void
ComputeMultipleCrystalPlasticityStress_abs::calculateEigenstrainDeformationGrad()
{
  _inverse_eigenstrain_deformation_grad.zero();
  _inverse_eigenstrain_deformation_grad.addIa(1.0);
