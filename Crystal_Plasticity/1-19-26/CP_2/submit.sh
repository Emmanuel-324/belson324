#!/bin/bash                                                                     
#SBATCH --job-name=CP_2.i                                            
#SBATCH --output=CP_2.%j.out 
#SBATCH --error=CP_2.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 52 /home/emmanuel324/projects/belson324/belson324-opt  -i  CP_2.i
