#!/bin/bash                                                                     
#SBATCH --job-name=CP_1.i                                            
#SBATCH --output=CP_1.%j.out 
#SBATCH --error=CP_1.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 52 /home/emmanuel324/projects/belson324/belson324-opt  -i  CP_1.i
