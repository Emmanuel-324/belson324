#!/bin/bash                                                                     
#SBATCH --job-name multiple_eigenstrains_test                                              
#SBATCH --out  multiple_eigenstrains_test.out        
#SBATCH --nodes 1                                                               
#SBATCH --ntasks 2
...
mpirun --mca orte_base_help_aggregate 0 -np 2 /home/emmanuel324/projects/belson/belson-opt  -i  multiple_eigenstrains_test.i
