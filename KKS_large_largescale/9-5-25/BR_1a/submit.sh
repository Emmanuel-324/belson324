#!/bin/bash                                                                     
#SBATCH --job-name=BR_1a.i                                            
#SBATCH --output=BR_1a.%j.out 
#SBATCH --error=BR_1a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 40 /home/emmanuel324/projects/belson324/belson324-opt  -i  BR_1a.i
