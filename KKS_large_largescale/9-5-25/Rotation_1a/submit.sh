#!/bin/bash                                                                     
#SBATCH --job-name=Rotation_1a.i                                            
#SBATCH --output=Rotation_1a.%j.out 
#SBATCH --error=Rotation_1a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Rotation_1a.i
