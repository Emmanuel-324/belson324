#!/bin/bash                                                                     
#SBATCH --job-name=Rotation_1b.i                                            
#SBATCH --output=Rotation_1b.%j.out 
#SBATCH --error=Rotation_1b.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Rotation_1b.i
