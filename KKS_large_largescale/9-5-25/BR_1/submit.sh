#!/bin/bash                                                                     
#SBATCH --job-name=BR_1.i                                            
#SBATCH --output=BR_1.%j.out 
#SBATCH --error=BR_1.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  BR_1.i
