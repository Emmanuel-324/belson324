#!/bin/bash                                                                     
#SBATCH --job-name=Sing1a_adt.i                                            
#SBATCH --output=Sing1a_adt.%j.out 
#SBATCH --error=Sing1a_adt.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 25 /home/emmanuel324/projects/belson324/belson324-opt  -i  Sing1a_adt.i
