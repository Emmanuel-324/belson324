...
[Functions]
  ...
  [./gb_scale_fn]
    ...
    symbol_values = '350.0     30.0     1     10.0'
  [../]
[]
...
[../]
  ...
  [./D11hm]
    ...
    material_property_names = 'D11 hm'
    expression = gb_scale_aux*(D11*hm)
    property_name = D11hm
  [../]
  [./D11hpv1]
    type = DerivativeParsedMaterial
    coupled_variables = 'gb_scale_aux'
    material_property_names = 'D11 hpv1'
    expression = gb_scale_aux*(D11*hpv1)
    property_name = D11hpv1
  [../]
  [./D11hpv2]
    type = DerivativeParsedMaterial
    coupled_variables = 'gb_scale_aux'
    material_property_names = 'D11 hpv2'
    expression = gb_scale_aux*(D11*hpv2)
    property_name = D11hpv2
  [../]
  [./D11hpv3]
    type = DerivativeParsedMaterial
    coupled_variables = 'gb_scale_aux'
    material_property_names = 'D11 hpv3'
    expression = gb_scale_aux*(D11*hpv3)
    property_name = D11hpv3
  [../]
# --- cross term for c1: D12
  [./D12hm]
    type = DerivativeParsedMaterial
    coupled_variables = 'gb_scale_aux'
    material_property_names = 'D12 hm'
    expression = gb_scale_aux*(D12*hm)
    property_name = D12hm
  [../]
  [./D12hpv1]
    type = DerivativeParsedMaterial
    coupled_variables = 'gb_scale_aux'
    material_property_names = 'D12 hpv1'
    expression = gb_scale_aux*(D12*hpv1)
    property_name = D12hpv1
  [../]
  [./D12hpv2]
    type = DerivativeParsedMaterial
    coupled_variables = 'gb_scale_aux'
    material_property_names = 'D12 hpv2'
    expression = gb_scale_aux*(D12*hpv2)
    property_name = D12hpv2
  [../]
  [./D12hpv3]
    type = DerivativeParsedMaterial
    coupled_variables = 'gb_scale_aux'
    material_property_names = 'D12 hpv3'
    expression = gb_scale_aux*(D12*hpv3)
    property_name = D12hpv3
  [../]
   #--- self terms for c2: D22
  [./D22hm]
    type = DerivativeParsedMaterial
    coupled_variables = 'gb_scale_aux'
    material_property_names = 'D22 hm'
    expression = gb_scale_aux*(D22*hm)
    property_name = D22hm
  [../]
  [./D22hpv1]
    type = DerivativeParsedMaterial
    coupled_variables = 'gb_scale_aux'
    material_property_names = 'D22 hpv1'
    expression = gb_scale_aux*(D22*hpv1)
    property_name = D22hpv1
  [../]
  [./D22hpv2]
    type = DerivativeParsedMaterial
    coupled_variables = 'gb_scale_aux'
    material_property_names = 'D22 hpv2'
    expression = gb_scale_aux*(D22*hpv2)
    property_name = D22hpv2
  [../]
  [./D22hpv3]
    type = DerivativeParsedMaterial
    coupled_variables = 'gb_scale_aux'
    material_property_names = 'D22 hpv3'
    expression = gb_scale_aux*(D22*hpv3)
    property_name = D22hpv3
  [../] 
# --- cross term for c2: D21
  [./D21hm]
    type = DerivativeParsedMaterial
    coupled_variables = 'gb_scale_aux'
    material_property_names = 'D21 hm'
    expression = gb_scale_aux*(D21*hm)
    property_name = D21hm
  [../]
  [./D21hpv1]
    type = DerivativeParsedMaterial
    coupled_variables = 'gb_scale_aux'
    material_property_names = 'D21 hpv1'
    expression = gb_scale_aux*(D21*hpv1)
    property_name = D21hpv1
  [../]
  [./D21hpv2]
    type = DerivativeParsedMaterial
    coupled_variables = 'gb_scale_aux'
    material_property_names = 'D21 hpv2'
    expression = gb_scale_aux*(D21*hpv2)
    property_name = D21hpv2
  [../]
  [./D21hpv3]
    type = DerivativeParsedMaterial
    coupled_variables = 'gb_scale_aux'
    material_property_names = 'D21 hpv3'
    expression = gb_scale_aux*(D21*hpv3)
    property_name = D21hpv3
  [../]
...
# Barrier functions for each phase
  ...
  [./constants]
    ...
    prop_names  = 'L    kappa D11   D12   D21  D22  misfit     W'
    prop_values = '0.3  0.01   1    0      0   1    1        0.01'
  [../]
