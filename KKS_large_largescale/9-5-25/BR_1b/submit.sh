#!/bin/bash                                                                     
#SBATCH --job-name=BR_1b.i                                            
#SBATCH --output=BR_1b.%j.out 
#SBATCH --error=BR_1b.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  BR_1b.i
