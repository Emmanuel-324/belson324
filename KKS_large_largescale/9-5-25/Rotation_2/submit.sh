#!/bin/bash                                                                     
#SBATCH --job-name=Rotation_2.i                                            
#SBATCH --output=Rotation_2.%j.out 
#SBATCH --error=Rotation_2.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Rotation_2.i
