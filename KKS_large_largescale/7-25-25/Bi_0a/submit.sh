#!/bin/bash                                                                     
#SBATCH --job-name=Bi_0a.i                                            
#SBATCH --output=Bi_0a.%j.out 
#SBATCH --error=Bi_0a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Bi_0a.i
