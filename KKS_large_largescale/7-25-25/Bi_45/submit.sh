#!/bin/bash                                                                     
#SBATCH --job-name=Bi_45.i                                            
#SBATCH --output=Bi_45.%j.out 
#SBATCH --error=Bi_45.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Bi_45.i
