#!/bin/bash                                                                     
#SBATCH --job-name=Bi_60a.i                                            
#SBATCH --output=Bi_60a.%j.out 
#SBATCH --error=Bi_60a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Bi_60a.i
