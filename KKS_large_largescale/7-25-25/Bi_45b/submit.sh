#!/bin/bash                                                                     
#SBATCH --job-name=Bi_45b.i                                            
#SBATCH --output=Bi_45b.%j.out 
#SBATCH --error=Bi_45b.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Bi_45b.i
