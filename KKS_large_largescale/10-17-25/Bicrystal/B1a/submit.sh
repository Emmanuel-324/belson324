#!/bin/bash                                                                     
#SBATCH --job-name=B1a.i                                            
#SBATCH --output=B1a.%j.out 
#SBATCH --error=B1a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 120 /home/emmanuel324/projects/belson324/belson324-opt  -i  B1a.i
