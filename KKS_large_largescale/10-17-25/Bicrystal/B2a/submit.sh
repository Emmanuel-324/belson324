#!/bin/bash                                                                     
#SBATCH --job-name=B2a.i                                            
#SBATCH --output=B2a.%j.out 
#SBATCH --error=B2a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 64 /home/emmanuel324/projects/belson324/belson324-opt  -i  B2a.i
