#!/bin/bash                                                                     
#SBATCH --job-name=XA1.i                                            
#SBATCH --output=XA1.%j.out 
#SBATCH --error=XA1.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 50 /home/emmanuel324/projects/belson324/belson324-opt  -i  XA1.i
