#!/bin/bash                                                                     
#SBATCH --job-name=XA4.i                                            
#SBATCH --output=XA4.%j.out 
#SBATCH --error=XA4.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 50 /home/emmanuel324/projects/belson324/belson324-opt  -i  XA4.i
