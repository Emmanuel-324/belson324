#!/bin/bash                                                                     
#SBATCH --job-name=XA3.i                                            
#SBATCH --output=XA3.%j.out 
#SBATCH --error=XA3.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 50 /home/emmanuel324/projects/belson324/belson324-opt  -i  XA3.i
