#!/bin/bash                                                                     
#SBATCH --job-name=SF3.i                                            
#SBATCH --output=SF3.%j.out 
#SBATCH --error=SF3.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 50 /home/emmanuel324/projects/belson324/belson324-opt  -i  SF3.i
