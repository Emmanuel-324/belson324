#!/bin/bash                                                                     
#SBATCH --job-name=SF3a.i                                            
#SBATCH --output=SF3a.%j.out 
#SBATCH --error=SF3a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 100 /home/emmanuel324/projects/belson324/belson324-opt  -i  SF3a.i
