#!/bin/bash                                                                     
#SBATCH --job-name=SF2.i                                            
#SBATCH --output=SF2.%j.out 
#SBATCH --error=SF2.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 50 /home/emmanuel324/projects/belson324/belson324-opt  -i  SF2.i
