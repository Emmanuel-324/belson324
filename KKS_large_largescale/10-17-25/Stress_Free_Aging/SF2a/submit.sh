#!/bin/bash                                                                     
#SBATCH --job-name=SF2a.i                                            
#SBATCH --output=SF2a.%j.out 
#SBATCH --error=SF2a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 100 /home/emmanuel324/projects/belson324/belson324-opt  -i  SF2a.i
