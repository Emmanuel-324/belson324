#!/bin/bash                                                                     
#SBATCH --job-name=SF1a.i                                            
#SBATCH --output=SF1a.%j.out 
#SBATCH --error=SF1a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 100 /home/emmanuel324/projects/belson324/belson324-opt  -i  SF1a.i
