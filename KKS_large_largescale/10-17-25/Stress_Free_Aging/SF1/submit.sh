#!/bin/bash                                                                     
#SBATCH --job-name=SF1.i                                            
#SBATCH --output=SF1.%j.out 
#SBATCH --error=SF1.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 50 /home/emmanuel324/projects/belson324/belson324-opt  -i  SF1.i
