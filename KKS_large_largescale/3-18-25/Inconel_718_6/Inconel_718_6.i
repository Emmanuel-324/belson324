...
[../]
  ...
  [./constants]
    ...
    prop_names  = 'M       L           kappa_gammaP  kappa_gammaDP    eps_sq   misfit  D'
    prop_values = '1e-3   2.904e-11     6.20e-10        1.24e-9         1.0     0.005  4.6e-17'
  [../]
...
[../]
  ...
  [../]
    ...
    [./ACInterface1]
      type = ACInterface
      variable = eta1
      kappa_name = kappa_gammaP
    [../]
    [./ACInterface2]
      type = ACInterface
      variable = eta2
      kappa_name = kappa_gammaDP
    [../]
