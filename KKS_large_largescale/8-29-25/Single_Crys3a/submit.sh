#!/bin/bash                                                                     
#SBATCH --job-name=Single_Crys3a.i                                            
#SBATCH --output=Single_Crys3a.%j.out 
#SBATCH --error=Single_Crys3a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Single_Crys3a.i
