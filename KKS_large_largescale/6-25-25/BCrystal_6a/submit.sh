#!/bin/bash                                                                     
#SBATCH --job-name=BCrystal_6a.i                                            
#SBATCH --output=BCrystal_6a.%j.out 
#SBATCH --error=BCrystal_6a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  BCrystal_6a.i
