#!/bin/bash                                                                     
#SBATCH --job-name=BCrystal_3.i                                            
#SBATCH --output=BCrystal_3.%j.out 
#SBATCH --error=BCrystal_3.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 8 /home/emmanuel324/projects/belson324/belson324-opt  -i  BCrystal_3.i
