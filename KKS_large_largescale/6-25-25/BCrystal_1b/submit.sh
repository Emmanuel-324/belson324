#!/bin/bash                                                                     
#SBATCH --job-name=BCrystal_1b.i                                            
#SBATCH --output=BCrystal_1b.%j.out 
#SBATCH --error=BCrystal_1b.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 10 /home/emmanuel324/projects/belson324/belson324-opt  -i  BCrystal_1b.i
