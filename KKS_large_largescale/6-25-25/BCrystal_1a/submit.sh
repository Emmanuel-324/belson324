#!/bin/bash                                                                     
#SBATCH --job-name=BCrystal_1a.i                                            
#SBATCH --output=BCrystal_1a.%j.out 
#SBATCH --error=BCrystal_1a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  BCrystal_1a.i
