#!/bin/bash                                                                     
#SBATCH --job-name=BCrystal_5.i                                            
#SBATCH --output=BCrystal_5.%j.out 
#SBATCH --error=BCrystal_5.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  BCrystal_5.i
