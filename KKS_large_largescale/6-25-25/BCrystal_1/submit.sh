#!/bin/bash                                                                     
#SBATCH --job-name=BCrystal_1.i                                            
#SBATCH --output=BCrystal_1.%j.out 
#SBATCH --error=BCrystal_1.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 14 /home/emmanuel324/projects/belson324/belson324-opt  -i  BCrystal_1.i
