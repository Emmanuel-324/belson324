#!/bin/bash                                                                     
#SBATCH --job-name=BCr_2.i                                            
#SBATCH --output=BCr_2.%j.out 
#SBATCH --error=BCr_2.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  BCr_2.i
