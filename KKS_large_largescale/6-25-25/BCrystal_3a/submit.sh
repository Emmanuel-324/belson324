#!/bin/bash                                                                     
#SBATCH --job-name=BCrystal_3a.i                                            
#SBATCH --output=BCrystal_3a.%j.out 
#SBATCH --error=BCrystal_3a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  BCrystal_3a.i
