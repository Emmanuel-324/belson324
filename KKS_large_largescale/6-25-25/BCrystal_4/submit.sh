#!/bin/bash                                                                     
#SBATCH --job-name=BCrystal_4.i                                            
#SBATCH --output=BCrystal_4.%j.out 
#SBATCH --error=BCrystal_4.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 10 /home/emmanuel324/projects/belson324/belson324-opt  -i  BCrystal_4.i
