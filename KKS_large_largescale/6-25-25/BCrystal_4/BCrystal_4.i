...
# Barrier functions for each phase
  ...
  [./stress_phasepv1_gr0]
    ...
    base_name =  'phasepv1_gr0 phasem_gr0'
    block = 0
  [../]
  [./stress_phasepv1_gr1]
    type = ComputeLinearElasticStress
    base_name = 'phasepv1_gr1 phasem_gr1'
    block = 1
  [../]
  [./stress_phasepv2_gr0]
    type = ComputeLinearElasticStress
    base_name = 'phasepv2_gr0 phasem_gr0'
    block = 0
  [../]
  [./stress_phasepv2_gr1]
    type = ComputeLinearElasticStress
    base_name = 'phasepv2_gr1 phasem_gr1'
    block = 1
  [../]
  [./stress_phasepv3_gr0]
    type = ComputeLinearElasticStress
    base_name = 'phasepv3_gr0 phasem_gr0'
    block = 0
  [../]
  [./stress_phasepv3_gr1]
    type = ComputeLinearElasticStress
    base_name = 'phasepv3_gr1 phasem_gr1'
    block = 1
  [../]
  [./stress_phasem_gr0]
    type = ComputeLinearElasticStress
  ...
  [./global_stress_gr0]
    ...
    phase_base = 'phasem_gr0 phasem_gr0 phasem_gr0 phasem_gr0'
    h          = 'hpv1_gr0     hpv2_gr0   hpv3_gr0   hm_gr0'
    block = '0'
  [../]
   [./global_stress_gr1]
    type = MultiPhaseStressMaterial
    phase_base = 'phasem_gr1 phasem_gr1 phasem_gr1 phasem_gr1'
