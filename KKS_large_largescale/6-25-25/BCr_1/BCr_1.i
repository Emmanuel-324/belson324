...
[./hm_gr0]
  ...
  coupled_variables = gr0
  expression = 'hm * gr0'
  property_name = hm_gr0
[../]
[./hpv1_gr0]
  type = DerivativeParsedMaterial
  material_property_names = 'hpv1'
  coupled_variables = gr0
  expression = 'hpv1 * gr0'
  property_name = hpv1_gr0
[../]
[./hpv2_gr0]
  type = DerivativeParsedMaterial
  material_property_names = 'hpv2'
  coupled_variables = gr0
  expression = 'hpv2 * gr0'
  property_name = hpv2_gr0
[../]
[./hpv3_gr0]
  type = DerivativeParsedMaterial
  material_property_names = 'hpv3'
  coupled_variables = gr0
  expression = 'hpv3 * gr0'
  property_name = hpv3_gr0
[../]
[./hm_gr1]
  type = DerivativeParsedMaterial
  material_property_names = 'hm'
