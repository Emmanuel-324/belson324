#!/bin/bash                                                                     
#SBATCH --job-name=BCrystal_2.i                                            
#SBATCH --output=BCrystal_2.%j.out 
#SBATCH --error=BCrystal_2.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  BCrystal_2.i
