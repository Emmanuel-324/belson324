#!/bin/bash                                                                     
#SBATCH --job-name=BCrystal_7.i                                            
#SBATCH --output=BCrystal_7.%j.out 
#SBATCH --error=BCrystal_7.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  BCrystal_7.i
