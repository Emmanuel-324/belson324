#!/bin/bash                                                                     
#SBATCH --job-name=GBEv_1post.i                                            
#SBATCH --output=GBEv_1post.%j.out 
#SBATCH --error=GBEv_1post.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  GBEv_1post.i
