#!/bin/bash                                                                     
#SBATCH --job-name=GBEv_1a.i                                            
#SBATCH --output=GBEv_1a.%j.out 
#SBATCH --error=GBEv_1a.%j.err       
#SBATCH --nodes=1                                                             
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  GBEv_1a.i
