#!/bin/bash                                                                     
#SBATCH --job-name=GBEv_1.i                                            
#SBATCH --output=GBEv_1.%j.out 
#SBATCH --error=GBEv_1.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 8 /home/emmanuel324/projects/belson324/belson324-opt  -i  GBEv_1.i
