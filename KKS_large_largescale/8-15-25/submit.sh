#!/bin/bash                                                                     
#SBATCH --job-name=Diffusion_2.i                                            
#SBATCH --output=Diffusion_2.%j.out 
#SBATCH --error=Diffusion_2.%j.err       
#SBATCH --ntasks=32
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Diffusion_2.i
