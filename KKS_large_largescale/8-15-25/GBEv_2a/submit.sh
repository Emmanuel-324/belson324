#!/bin/bash                                                                     
#SBATCH --job-name=GBEv_2a.i                                            
#SBATCH --output=GBEv_2a.%j.out 
#SBATCH --error=GBEv_2a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 12 /home/emmanuel324/projects/belson324/belson324-opt  -i  GBEv_2a.i
