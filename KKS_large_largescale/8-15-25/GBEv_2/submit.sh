#!/bin/bash                                                                     
#SBATCH --job-name=GBEv_2.i                                            
#SBATCH --output=GBEv_2.%j.out 
#SBATCH --error=GBEv_2.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 12 /home/emmanuel324/projects/belson324/belson324-opt  -i  GBEv_2.i
