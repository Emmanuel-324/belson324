#!/bin/bash                                                                     
#SBATCH --job-name=Eigen2_45.i                                            
#SBATCH --output=Eigen2_45.%j.out 
#SBATCH --error=Eigen2_45.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Eigen2_45.i
