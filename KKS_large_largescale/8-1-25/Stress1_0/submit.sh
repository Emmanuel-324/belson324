#!/bin/bash                                                                     
#SBATCH --job-name=Stress1_0.i                                            
#SBATCH --output=Stress1_0.%j.out 
#SBATCH --error=Stress1_0.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Stress1_0.i
