...
[../]
  ...
  [./Dhpv1]
    type = DerivativeParsedMaterial
    material_property_names = 'D_Nb hpv1'
    expression = D_Nb*hpv1
    property_name = Dhpv1
  [../]
  [./Dhpv2]
    type = DerivativeParsedMaterial
    material_property_names = 'D_Al hpv2'
    expression = D_Al*hpv2
    property_name = Dhpv2
  [../]
  [./Dhpv3]
    type = DerivativeParsedMaterial
    material_property_names = 'D_Nb hpv3'
    expression = D_Nb*hpv3
    property_name = Dhpv3
  [../]
...
# Barrier functions for each phase
  ...
  [./constants]
    ...
    prop_names  = 'L    kappa    D_Al        D_Nb     misfit        W'
    prop_values = '0.3  0.01    3.0e-12     2.6e-12      1        0.01'
  [../]
