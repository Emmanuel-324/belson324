...
#SBATCH --output=Diffusion_1.%j.out 
#SBATCH --error=Diffusion_1.%j.err       
#SBATCH --ntasks=32
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Diffusion_1.i
