#!/bin/bash                                                                     
#SBATCH --job-name=Eigen1_45.i                                            
#SBATCH --output=Eigen1_45.%j.out 
#SBATCH --error=Eigen1_45.%j.err       
#SBATCH --ntasks=48
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Eigen1_45.i
