#!/bin/bash                                                                     
#SBATCH --job-name=Eigen2_0.i                                            
#SBATCH --output=Eigen2_0.%j.out 
#SBATCH --error=Eigen2_0.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Eigen2_0.i
