#!/bin/bash                                                                     
#SBATCH --job-name=Eigen1_0.i                                            
#SBATCH --output=Eigen1_0.%j.out 
#SBATCH --error=Eigen1_0.%j.err       
#SBATCH --nodes=2                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Eigen1_0.i
