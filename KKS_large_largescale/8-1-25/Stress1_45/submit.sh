#!/bin/bash                                                                     
#SBATCH --job-name=Stress1_45.i                                            
#SBATCH --output=Stress1_45.%j.out 
#SBATCH --error=Stress1_45.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Stress1_45.i
