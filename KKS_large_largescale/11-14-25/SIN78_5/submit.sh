#!/bin/bash                                                                     
#SBATCH --job-name=SIN78_5.i                                            
#SBATCH --output=SIN78_5.%j.out 
#SBATCH --error=SIN78_5.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 30 /home/emmanuel324/projects/belson324/belson324-opt  -i  SIN78_5.i
