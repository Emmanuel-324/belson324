#!/bin/bash                                                                     
#SBATCH --job-name=SIN78_3.i                                            
#SBATCH --output=SIN78_3.%j.out 
#SBATCH --error=SIN78_3.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 30 /home/emmanuel324/projects/belson324/belson324-opt  -i  SIN78_3.i
