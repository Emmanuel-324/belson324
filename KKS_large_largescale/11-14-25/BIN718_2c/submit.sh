#!/bin/bash                                                                     
#SBATCH --job-name=BIN718_2c.i                                            
#SBATCH --output=BIN718_2c.%j.out 
#SBATCH --error=BIN718_2c.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 45 /home/emmanuel324/projects/belson324/belson324-opt  -i  BIN718_2c.i
