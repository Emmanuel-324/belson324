#!/bin/bash                                                                     
#SBATCH --job-name=BIN718_1b.i                                            
#SBATCH --output=BIN718_1b.%j.out 
#SBATCH --error=BIN718_1b.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 45 /home/emmanuel324/projects/belson324/belson324-opt  -i  BIN718_1b.i
