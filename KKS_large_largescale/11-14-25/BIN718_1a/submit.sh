#!/bin/bash                                                                     
#SBATCH --job-name=BIN718_1a.i                                            
#SBATCH --output=BIN718_1a.%j.out 
#SBATCH --error=BIN718_1a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 45 /home/emmanuel324/projects/belson324/belson324-opt  -i  BIN718_1a.i
