#!/bin/bash                                                                     
#SBATCH --job-name=Area_frac1a.i                                            
#SBATCH --output=Area_frac1a.%j.out 
#SBATCH --error=Area_frac1a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 30 /home/emmanuel324/projects/belson324/belson324-opt  -i  Area_frac1a.i
