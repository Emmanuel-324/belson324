#!/bin/bash                                                                     
#SBATCH --job-name=E_03a.i                                            
#SBATCH --output=E_03a.%j.out 
#SBATCH --error=E_03a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 25 /home/emmanuel324/projects/belson324/belson324-opt  -i  E_03a.i
