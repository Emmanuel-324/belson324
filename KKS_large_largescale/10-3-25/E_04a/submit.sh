#!/bin/bash                                                                     
#SBATCH --job-name=E_04a.i                                            
#SBATCH --output=E_04a.%j.out 
#SBATCH --error=E_04a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 25 /home/emmanuel324/projects/belson324/belson324-opt  -i  E_04a.i
