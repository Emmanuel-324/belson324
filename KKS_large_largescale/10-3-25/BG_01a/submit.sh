#!/bin/bash                                                                     
#SBATCH --job-name=BG_01a.i                                            
#SBATCH --output=BG_01a.%j.out 
#SBATCH --error=BG_01a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 40 /home/emmanuel324/projects/belson324/belson324-opt  -i  BG_01a.i
