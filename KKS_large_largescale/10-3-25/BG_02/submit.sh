#!/bin/bash                                                                     
#SBATCH --job-name=BG_02.i                                            
#SBATCH --output=BG_02.%j.out 
#SBATCH --error=BG_02.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 40 /home/emmanuel324/projects/belson324/belson324-opt  -i  BG_02.i
