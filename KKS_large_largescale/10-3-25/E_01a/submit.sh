#!/bin/bash                                                                     
#SBATCH --job-name=E_01a.i                                            
#SBATCH --output=E_01a.%j.out 
#SBATCH --error=E_01a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 25 /home/emmanuel324/projects/belson324/belson324-opt  -i  E_01a.i
