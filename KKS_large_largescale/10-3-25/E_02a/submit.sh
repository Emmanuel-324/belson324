#!/bin/bash                                                                     
#SBATCH --job-name=E_02a.i                                            
#SBATCH --output=E_02a.%j.out 
#SBATCH --error=E_02a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 25 /home/emmanuel324/projects/belson324/belson324-opt  -i  E_02a.i
