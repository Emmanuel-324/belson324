#!/bin/bash                                                                     
#SBATCH --job-name=BG_03.i                                            
#SBATCH --output=BG_03.%j.out 
#SBATCH --error=BG_03.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 40 /home/emmanuel324/projects/belson324/belson324-opt  -i  BG_03.i
