#!/bin/bash                                                                     
#SBATCH --job-name=Area_frac1.i                                            
#SBATCH --output=Area_frac1.%j.out 
#SBATCH --error=Area_frac1.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 30 /home/emmanuel324/projects/belson324/belson324-opt  -i  Area_frac1.i
