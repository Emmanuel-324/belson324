#!/bin/bash                                                                     
#SBATCH --job-name=B6b_45.i                                            
#SBATCH --output=B6b_45.%j.out 
#SBATCH --error=B6b_45.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  B6b_45.i
