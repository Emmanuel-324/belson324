#!/bin/bash                                                                     
#SBATCH --job-name=B6_45a.i                                            
#SBATCH --output=B6_45a.%j.out 
#SBATCH --error=B6_45a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  B6_45a.i
