...
# ---- Nb (c2) enrichment at the grain boundary (x = 350 sim units) ----
  ...
  [./c2_gb_enrich_fn]
  type  = ParsedFunction
  value = '0.038 + 0.18*exp(-((x - 350)/5.0)^2)'   # peaks ~0.218
[../]
[]
...
[ICs]
  ...
  # delta slab inside right grain only (approx. from x = 360 to 380)
[./eta_pv4_slab_ic]
  type     = FunctionIC
  variable = eta_pv4
  function = '0.8 * 0.5*(tanh((x - 360.0)/1.0) - tanh((x - 380.0)/1.0))'
[../]
...
[./fc_pv4]
  ...
  expression = '35*((c1pv4 - 0.020)^2 + 2*(c2pv4 - 0.22)^2)'
[../]
...
# Barrier functions for each phase
  ...
  [./constants]
    ...
    prop_values = '0.3  5e-1        0.01    0.002   1    1        0.01'
  [../]
  #[./gate_3h_prop]
