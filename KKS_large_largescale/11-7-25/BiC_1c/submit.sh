#!/bin/bash                                                                     
#SBATCH --job-name=BiC_1c.i                                            
#SBATCH --output=BiC_1c.%j.out 
#SBATCH --error=BiC_1c.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 34 /home/emmanuel324/projects/belson324/belson324-opt  -i  BiC_1c.i
