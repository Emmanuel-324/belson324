#!/bin/bash                                                                     
#SBATCH --job-name=BiC_1b.i                                            
#SBATCH --output=BiC_1b.%j.out 
#SBATCH --error=BiC_1b.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 34 /home/emmanuel324/projects/belson324/belson324-opt  -i  BiC_1b.i
