#!/bin/bash                                                                     
#SBATCH --job-name=BiC_2.i                                            
#SBATCH --output=BiC_2.%j.out 
#SBATCH --error=BiC_2.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 30 /home/emmanuel324/projects/belson324/belson324-opt  -i  BiC_2.i
