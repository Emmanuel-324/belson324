#!/bin/bash                                                                     
#SBATCH --job-name=BiC_3.i                                            
#SBATCH --output=BiC_3.%j.out 
#SBATCH --error=BiC_3.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 30 /home/emmanuel324/projects/belson324/belson324-opt  -i  BiC_3.i
