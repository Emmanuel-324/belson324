#!/bin/bash                                                                     
#SBATCH --job-name=2D_Test_1.i                                            
#SBATCH --output=2D_Test_1.%j.out 
#SBATCH --error=2D_Test_1.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 8 /home/emmanuel324/projects/belson324/belson324-opt  -i  2D_Test_1.i
