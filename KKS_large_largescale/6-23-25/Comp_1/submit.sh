#!/bin/bash                                                                     
#SBATCH --job-name=Comp_1.i                                            
#SBATCH --output=Comp_1.%j.out 
#SBATCH --error=Comp_1.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Comp_1.i
