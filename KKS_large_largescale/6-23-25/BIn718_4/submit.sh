#!/bin/bash                                                                     
#SBATCH --job-name=BIn718_4.i                                            
#SBATCH --output=BIn718_4.%j.out 
#SBATCH --error=BIn718_4.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  BIn718_4.i
