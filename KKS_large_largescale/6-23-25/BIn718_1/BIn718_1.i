...
[Materials]
  ...
  [./f2]
    ...
    expression = '50.0*((c1pv2-0.197)^2+2*(c2pv2-0.177)^2)'
  [../]
...
# Barrier functions for each phase
  ...
  [./stress_phasepv3]
    ...
    block = '0 1'
  [../]
  [./stress_phasem_grain1]
    type = ComputeLinearElasticStress
    base_name = phasem
    block = '0'
  [../]
  [./stress_phasem_grain2]
    type = ComputeLinearElasticStress
    base_name = phasem
    block = '1'
  [../]

  [./strain_phasem_grain1]
    type = ComputeSmallStrain
    displacements = 'disp_x disp_y'
    base_name = phasem
    block = '0'
  [../]
  [./strain_phasem_grain2]
    type = ComputeSmallStrain
    displacements = 'disp_x disp_y'
    base_name = phasem
    block = '0'
