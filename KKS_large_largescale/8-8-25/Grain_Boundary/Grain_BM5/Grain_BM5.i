...
[ICs]
  ...
  [./PolycrystalICs]
    [./BicrystalBoundingBoxIC]
      x1 = 0
      y1 = 0
      x2 = 350      # <-- box edge aligned to stitched interface
      y2 = 350
      # optional: restrict to both blocks, but not required since the box spans them
    [../]
  [../]
[]
[GlobalParams]
...
[Materials]
  ...
  [./gb_mask]
  type = ParsedMaterial
  property_name = gb_mask
  coupled_variables = 'gr0'
  expression = '4*gr0*(1-gr0)'   # peaks at GB (same if you use gr1)
[../]
...
# Barrier functions for each phase
  ...
  [../]
   [./gb_knobs]
    type = GenericConstantMaterial
    prop_names  = 'a_gb  b_gb  D_gb  k_gb'
    prop_values = '0.3   0.5   2.0   -0.02'   # start: taper bulk D 30%; 2× GB D; mild GB attraction
  [../]
 # Mobility gated by grain + boosted at GB
  [./L_pv1_gr0_eff]
    type = ParsedMaterial
    property_name = L_pv1_gr0_eff
    material_property_names = 'h_gr0 gb_mask L_gr0 b_gb'
    expression = 'L_gr0 * h_gr0 * (1 + b_gb*gb_mask)'
  [../]
  [./L_pv1_gr1_eff]
    type = ParsedMaterial
    property_name = L_pv1_gr1_eff
    material_property_names = 'h_gr1 gb_mask L_gr1 b_gb'
    expression = 'L_gr1 * h_gr1 * (1 + b_gb*gb_mask)'
  [../]
  [./L_pv2_gr0_eff]
    type = ParsedMaterial
    property_name = L_pv2_gr0_eff
    material_property_names = 'h_gr0 gb_mask L_gr0 b_gb'
    expression = 'L_gr0 * h_gr0 * (1 + b_gb*gb_mask)'
  [../]
  [./L_pv2_gr1_eff]
    type = ParsedMaterial
    property_name = L_pv2_gr1_eff
    material_property_names = 'h_gr1 gb_mask L_gr1 b_gb'
    expression = 'L_gr1 * h_gr1 * (1 + b_gb*gb_mask)'
  [../]
  [./L_pv3_gr0_eff]
    type = ParsedMaterial
    property_name = L_pv3_gr0_eff
    material_property_names = 'h_gr0 gb_mask L_gr0 b_gb'
    expression = 'L_gr0 * h_gr0 * (1 + b_gb*gb_mask)'
  [../]
  [./L_pv3_gr1_eff]
    type = ParsedMaterial
    property_name = L_pv3_gr1_eff
    material_property_names = 'h_gr1 gb_mask L_gr1 b_gb'
    expression = 'L_gr1 * h_gr1 * (1 + b_gb*gb_mask)'
  [../]
 ...
 [./eigen_strainpv1_gr0]
    ...
    base_name = phasepv1_gr0
    eigen_base = '0.018 0.0067 0 0 0 0'
  ...
  [./eigen_strainpv3_gr0]
    type = ComputeEigenstrain
    base_name = phasepv3_gr0
    eigen_base = '0.0067 0.018 0 0 0 0'
    prefactor = misfit_gr0
...
[Executioner]
  ...
  [./TimeStepper]
    ...
    dt                 = 1e-3     # slightly smaller starter step for interfaces
    optimal_iterations = 12       # target a moderately stiff solve
    growth_factor      = 1.15     # gentler growth
    cutback_factor     = 0.5      # back off aggressively on tough steps
  [../]
