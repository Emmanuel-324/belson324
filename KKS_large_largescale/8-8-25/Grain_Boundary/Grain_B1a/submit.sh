#!/bin/bash                                                                     
#SBATCH --job-name=Grain_B1a.i                                            
#SBATCH --output=Grain_B1a.%j.out 
#SBATCH --error=Grain_B1a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Grain_B1a.i
