#!/bin/bash                                                                     
#SBATCH --job-name=Bicrystal1.i                                            
#SBATCH --output=Bicrystal1.%j.out 
#SBATCH --error=Bicrystal1.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Bicrystal1.i
