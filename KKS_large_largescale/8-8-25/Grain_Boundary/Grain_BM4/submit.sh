#!/bin/bash                                                                     
#SBATCH --job-name=Grain_BM4.i                                            
#SBATCH --output=Grain_BM4.%j.out 
#SBATCH --error=Grain_BM4.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 8 /home/emmanuel324/projects/belson324/belson324-opt  -i  Grain_BM4.i
