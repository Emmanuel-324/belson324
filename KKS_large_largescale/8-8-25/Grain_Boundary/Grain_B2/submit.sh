#!/bin/bash                                                                     
#SBATCH --job-name=Grain_B2.i                                            
#SBATCH --output=Grain_B2.%j.out 
#SBATCH --error=Grain_B2.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 14 /home/emmanuel324/projects/belson324/belson324-opt  -i  Grain_B2.i
