#!/bin/bash                                                                     
#SBATCH --job-name=Grain_BM2.i                                            
#SBATCH --output=Grain_BM2.%j.out 
#SBATCH --error=Grain_BM2.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 8 /home/emmanuel324/projects/belson324/belson324-opt  -i  Grain_BM2.i
