#!/bin/bash                                                                     
#SBATCH --job-name=Euler_2.i                                            
#SBATCH --output=Euler_2.%j.out 
#SBATCH --error=Euler_2.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Euler_2.i
