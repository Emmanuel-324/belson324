#!/bin/bash                                                                     
#SBATCH --job-name=Diffusion_3.i                                            
#SBATCH --output=Diffusion_3.%j.out 
#SBATCH --error=Diffusion_3.%j.err       
#SBATCH --ntasks=32
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Diffusion_3.i
