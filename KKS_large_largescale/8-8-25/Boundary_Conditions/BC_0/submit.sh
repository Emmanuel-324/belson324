#!/bin/bash                                                                     
#SBATCH --job-name=BC_0.i                                            
#SBATCH --output=BC_0.%j.out 
#SBATCH --error=BC_0.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 15 /home/emmanuel324/projects/belson324/belson324-opt  -i  BC_0.i
