#!/bin/bash                                                                     
#SBATCH --job-name=Euler_4.i                                            
#SBATCH --output=Euler_4.%j.out 
#SBATCH --error=Euler_4.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Euler_4.i
