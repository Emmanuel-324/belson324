...
[./misfit_c_fn]
  type  = ParsedFunction
  value = '0.5*(1 + tanh(((t/1659.45) - 1.8)/0.2)) * (0.0286 / (1 + exp(-(((t/1659.45) - (-2.22))/2.89))))'
[../]


[./misfit_a_fn]
  type  = ParsedFunction
  value = '0.5*(1 + tanh(((t/1659.45) - 1.8)/0.2)) * (0.0120 * pow((((t/1659.45) - 1.8)/1.9), 2.0) * exp(-(((t/1659.45) - 1.8)/1.9)))'
[../]
