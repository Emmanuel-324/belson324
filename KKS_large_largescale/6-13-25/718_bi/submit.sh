#!/bin/bash                                                                     
#SBATCH --job-name=718_bi.i                                            
#SBATCH --output=718_bi.%j.out 
#SBATCH --error=718_bi.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 15 /home/emmanuel324/projects/belson324/belson324-opt  -i  718_bi.i
