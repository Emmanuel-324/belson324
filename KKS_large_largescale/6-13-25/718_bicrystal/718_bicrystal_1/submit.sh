#!/bin/bash                                                                     
#SBATCH --job-name=boundingbox.i                                            
#SBATCH --output=boundingbox.%j.out 
#SBATCH --error=boundingbox.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 15 /home/emmanuel324/projects/belson324/belson324-opt  -i  boundingbox.i
