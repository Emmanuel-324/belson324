#!/bin/bash                                                                     
#SBATCH --job-name=BM_2.i                                            
#SBATCH --output=BM_2.%j.out 
#SBATCH --error=BM_2.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 64 /home/emmanuel324/projects/belson324/belson324-opt  -i  BM_2.i
