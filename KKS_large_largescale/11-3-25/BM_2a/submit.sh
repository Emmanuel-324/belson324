#!/bin/bash                                                                     
#SBATCH --job-name=BM_2a.i                                            
#SBATCH --output=BM_2a.%j.out 
#SBATCH --error=BM_2a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 24 /home/emmanuel324/projects/belson324/belson324-opt  -i  BM_2a.i
