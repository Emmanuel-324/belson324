#!/bin/bash                                                                     
#SBATCH --job-name=BM_1a.i                                            
#SBATCH --output=BM_1a.%j.out 
#SBATCH --error=BM_1a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 40 /home/emmanuel324/projects/belson324/belson324-opt  -i  BM_1a.i
