...
[Materials]
  ...
  [./fc_pv1]
    ...
    f_name = fc_pv1
    args = 'c1pv1 c2pv1'
    function = '50.0*((c1pv1-0.000727)^2+2*(c2pv1-0.196)^2) + 1548.5'
  [../]
  ...
  [./f3]
    ...
    f_name = fc_pv3
    args = 'c1pv3 c2pv3'
    function = '50.0*((c1pv3-0.000727)^2+2*(c2pv3-0.196)^2) + 1548.5'
  [../]
  ...
  [./f4]
    ...
    f_name = fc_pv4
    args = 'c1pv4 c2pv4'
    function = '50.0*((c1pv4-0.000727)^2+2*(c2pv4-0.196)^2) + 1548.5'
  [../]
