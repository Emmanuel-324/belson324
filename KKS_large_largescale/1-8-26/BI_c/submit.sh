#!/bin/bash                                                                     
#SBATCH --job-name=BI_1c.i                                            
#SBATCH --output=BI_1c.%j.out 
#SBATCH --error=BI_1c.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 62 /home/emmanuel324/projects/belson324/belson324-opt  -i  BI_1c.i
