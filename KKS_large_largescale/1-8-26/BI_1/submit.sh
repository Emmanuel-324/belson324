#!/bin/bash                                                                     
#SBATCH --job-name=BI_1.i                                            
#SBATCH --output=BI_1.%j.out 
#SBATCH --error=BI_1.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 62 /home/emmanuel324/projects/belson324/belson324-opt  -i  BI_1.i
