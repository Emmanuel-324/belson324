#!/bin/bash                                                                     
#SBATCH --job-name=BI_1b.i                                            
#SBATCH --output=BI_1b.%j.out 
#SBATCH --error=BI_1b.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 62 /home/emmanuel324/projects/belson324/belson324-opt  -i  BI_1b.i
