#!/bin/bash                                                                     
#SBATCH --job-name=TW_3.i                                            
#SBATCH --output=TW_3.%j.out 
#SBATCH --error=TW_3.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 62 /home/emmanuel324/projects/belson324/belson324-opt  -i  TW_3.i
