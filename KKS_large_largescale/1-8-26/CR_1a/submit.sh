#!/bin/bash                                                                     
#SBATCH --job-name=CR_1a.i                                            
#SBATCH --output=CR_1a.%j.out 
#SBATCH --error=CR_1a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 62 /home/emmanuel324/projects/belson324/belson324-opt  -i  CR_1a.i
