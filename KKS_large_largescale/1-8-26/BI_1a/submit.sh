#!/bin/bash                                                                     
#SBATCH --job-name=BI_1a.i                                            
#SBATCH --output=BI_1a.%j.out 
#SBATCH --error=BI_1a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 62 /home/emmanuel324/projects/belson324/belson324-opt  -i  BI_1a.i
