#!/bin/bash                                                                     
#SBATCH --job-name=CR_1b.i                                            
#SBATCH --output=CR_1b.%j.out 
#SBATCH --error=CR_1b.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 62 /home/emmanuel324/projects/belson324/belson324-opt  -i  CR_1b.i
