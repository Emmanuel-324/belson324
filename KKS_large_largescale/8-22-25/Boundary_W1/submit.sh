#!/bin/bash                                                                     
#SBATCH --job-name=Boundary_W1.i                                            
#SBATCH --output=Boundary_W1.%j.out 
#SBATCH --error=Boundary_W1.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Boundary_W1.i
