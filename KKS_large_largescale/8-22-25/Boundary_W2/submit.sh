#!/bin/bash                                                                     
#SBATCH --job-name=Boundary_W2.i                                            
#SBATCH --output=Boundary_W2.%j.out 
#SBATCH --error=Boundary_W2.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Boundary_W2.i
