#!/bin/bash                                                                     
#SBATCH --job-name=Eigen_00.i                                            
#SBATCH --output=Eigen_00.%j.out 
#SBATCH --error=Eigen_00.%j.err       
#SBATCH --nodes=1                                                             
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Eigen_00.i
