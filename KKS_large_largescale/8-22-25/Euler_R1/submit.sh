#!/bin/bash                                                                     
#SBATCH --job-name=Euler_R1.i                                            
#SBATCH --output=Euler_R1.%j.out 
#SBATCH --error=Euler_R1.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Euler_R1.i
