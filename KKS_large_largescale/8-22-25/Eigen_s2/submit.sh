#!/bin/bash                                                                     
#SBATCH --job-name=Eigen_s2.i                                            
#SBATCH --output=Eigen_s2.%j.out 
#SBATCH --error=Eigen_s2.%j.err       
#SBATCH --nodes=1                                                             
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  Eigen_s2.i
