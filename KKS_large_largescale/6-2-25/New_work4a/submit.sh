#!/bin/bash                                                                     
#SBATCH --job-name=New_work4a.i                                            
#SBATCH --output=New_work4a.%j.out 
#SBATCH --error=New_work4a.%j.err 
...
/home/emmanuel324/projects/belson324/belson324-opt  -i  New_work4a.i
