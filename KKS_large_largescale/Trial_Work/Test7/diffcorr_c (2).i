...
#    block = 0
  ...
  [./e_xx]
    type = RankTwoAux
    variable = e_xx
    rank_two_tensor = uncracked_lage
    index_j = 0
    index_i = 0
    execute_on = timestep_end
#    block = 0
...
[Executioner]
  ...
  [./Adaptivity]
    ...
    max_h_level = 1 # Max number of refinements used, starting from initial mesh (befo# uniform refinement)
  [../]
[]
