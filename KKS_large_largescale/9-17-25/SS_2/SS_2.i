...
[BCs]
  ...
  [./x_part_right]
    ...
    variable      = disp_x
    factor        = -0.0707107   # Tx =  T/√2 ; negative => tension (outward)
  [../]
  [./x_part_left]
    type          = Pressure
    ...
    displacements = 'disp_x disp_y'
    variable      = disp_x
    factor        = 0.0707107   # opposite sign for symmetry
  [../]
  ...
  [./y_part_top]
    ...
    displacements = 'disp_x disp_y'
    variable      = disp_y
    factor        = -0.0707107   # Ty =  T/√2 ; negative => tension
  [../]
  [./y_part_bottom]
    type          = Pressure
...
# Barrier functions for each phase
  ...
  [./Stiffness_phasepv1]
    type = ComputeElasticityTensor
    C_ijkl = '290.6 187 160.7 290.6 187 209.6 114.2 114.2 119.2'#Ghorbanpour, S., et al., A crystal plasticity model incorporating the effects of    
    base_name = phasepv1
    euler_angle_1 = 45
    euler_angle_2 = 0
    euler_angle_3 = 0
