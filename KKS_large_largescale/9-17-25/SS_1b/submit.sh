#!/bin/bash                                                                     
#SBATCH --job-name=SS_1b.i                                            
#SBATCH --output=SS_1b.%j.out 
#SBATCH --error=SS_1b.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  SS_1b.i
