#!/bin/bash                                                                     
#SBATCH --job-name=BC_1.i                                            
#SBATCH --output=BC_1.%j.out 
#SBATCH --error=BC_1.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 62 /home/emmanuel324/projects/belson324/belson324-opt  -i  BC_1.i
