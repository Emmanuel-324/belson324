#!/bin/bash                                                                     
#SBATCH --job-name=BC_3.i                                            
#SBATCH --output=BC_3.%j.out 
#SBATCH --error=BC_3.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 62 /home/emmanuel324/projects/belson324/belson324-opt  -i  BC_3.i
