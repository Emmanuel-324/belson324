#!/bin/bash                                                                     
#SBATCH --job-name=SIN_2b.i                                            
#SBATCH --output=SIN_2b.%j.out 
#SBATCH --error=SIN_2b.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 62 /home/emmanuel324/projects/belson324/belson324-opt  -i  SIN_2b.i
