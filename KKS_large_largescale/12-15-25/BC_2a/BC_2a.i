...
[Functions]
  ...
  [../]
   ...
   [./gb_scale_fn]
    ...
    symbol_values = '500.0     100.0     1     15'
  [../]
   [./gb_mob_mask_fn]
    type = ParsedFunction
    # 1 inside the band, 0 outside
    expression = '0.5*(tanh((w_mob/2 - abs(x - x0))/delta) + 1)'
    symbol_names  = 'x0   w_mob  delta'
    symbol_values = '500  100     1'
  [../]
 [./misfit_c_fn]
    type  = ParsedFunction
  # ε_c(t_h) = ε_c0 / (1 + exp(-((t_h/τ - t0)/k)))
    value = '0.0286 / (1 + exp(-((t/3600 - (-2.22))/2.89)))'
  [../]
  ...
  value = '(0.0120) * pow(( (t/3600)/2.75 ), 2.0) * exp(-( (t/3600)/2.75 ))'
 [../]
 [./delta_time_ramp]
  type = ParsedFunction
  # turns on gradually after t_on
  expression = '0.5*(1 + tanh((t - t_on)/tau))'
  symbol_names  = 't_on tau'
  symbol_values = '7200 100'
[../]
...
[./hgpp2]
  ...
  [./constants]
    ...
    prop_values = '0.00465   0.00465   0.00465   0.00465   3.87   7.74   7.74    7.74   46     1        0.01'
  [../]
  [./misfit_props]
  ...
  coupled_variables = 'gb_mob_aux'
  material_property_names = 'L_d delta_time_ramp'
  expression = 'L_d * gb_mob_aux * delta_time_ramp'
[../]
 [./delta_time_ramp_mat]
    type = GenericFunctionMaterial
    prop_names  = 'delta_time_ramp'
    prop_values = 'delta_time_ramp'
  [../]
...
[./Stiffness_phasegpp1_g0]
 ...
 # =========================
  # γ'' variant 1 (gpp1): c along x
  # =========================
  [./eigen_straingpp1_g0c]
    type = ComputeRotatedEigenstrain
    base_name = phasegpp1
    eigen_base = '1 0 0 0 0 0'     # εc on xx
    Euler_angles = '0 0 0'
    prefactor = misfit_c
  ...
  [./eigen_straingpp1_g0a]
    type = ComputeRotatedEigenstrain
    base_name = phasegpp1
    eigen_base = '0 1 1 0 0 0'     # εa on yy, zz
    Euler_angles = '0 0 0'
    prefactor = misfit_a
  ...
  # =========================
  # γ'' variant 2 (gpp2): c along y  (orthogonal to gpp1)
  # =========================
  [./eigen_straingpp2_g0c]
    type = ComputeRotatedEigenstrain
    base_name = phasegpp2
    eigen_base = '0 1 0 0 0 0'     # εc on yy  <-- DIFFERENT!
    Euler_angles = '0 0 0'
    prefactor = misfit_c
  ...
  [./eigen_straingpp2_g0a]
    type = ComputeRotatedEigenstrain
    base_name = phasegpp2
    eigen_base = '1 0 1 0 0 0'     # εa on xx, zz <-- DIFFERENT!
    Euler_angles = '0 0 0'
    prefactor = misfit_a
...
# =========================
# Grain 1 (block=1): rotate in-plane by 45° about Z
# =========================

# Variant 1 rotated with grain 1 (about z)
[./eigen_straingpp1_g1c]
  type = ComputeRotatedEigenstrain
  base_name = phasegpp1
...
[./eigen_straingpp1_g1a]
  type = ComputeRotatedEigenstrain
  base_name = phasegpp1
  eigen_base = '0 1 1 0 0 0'
  Euler_angles = '45 0 0'
  prefactor = misfit_a
  eigenstrain_name = eigenstraingpp1_a
  block = 1
...
# Variant 2 rotated with grain 1 (about z)
[./eigen_straingpp2_g1c]
  type = ComputeRotatedEigenstrain
  base_name = phasegpp2
...
[./eigen_straingpp2_g1a]
  type = ComputeRotatedEigenstrain
  base_name = phasegpp2
  eigen_base = '1 0 1 0 0 0'
  Euler_angles = '45 0 0'
  prefactor = misfit_a
  eigenstrain_name = eigenstraingpp2_a
  block = 1
[../]
  ...
  [./eigen_straind]
    type = ComputeRotatedEigenstrain
    base_name = phased
    eigen_base = '0.00532 0.03 0 0 0 0'
    Euler_angles = '0 0 0'
    prefactor = misfit
...
# weighted hpv by g (use your actual hpv variable names)
  ...
  [./Energy_total]
    ...
    Fj_names = 'F_gp F_gpp1 F_gpp2 F_d'
    hj_names = 'hgp hgpp1 hgpp2 hd'
    gj_names = 'gp gpp1 gpp2 gd'
    variable = Energy
    w = 1
