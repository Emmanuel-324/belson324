#!/bin/bash                                                                     
#SBATCH --job-name=BC_2a.i                                            
#SBATCH --output=BC_2a.%j.out 
#SBATCH --error=BC_2a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 62 /home/emmanuel324/projects/belson324/belson324-opt  -i  BC_2a.i
