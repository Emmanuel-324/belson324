#!/bin/bash                                                                     
#SBATCH --job-name=SIN_2.i                                            
#SBATCH --output=SIN_2.%j.out 
#SBATCH --error=SIN_2.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 62 /home/emmanuel324/projects/belson324/belson324-opt  -i  SIN_2.i
