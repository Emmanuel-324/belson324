#!/bin/bash                                                                     
#SBATCH --job-name=SIN_2a.i                                            
#SBATCH --output=SIN_2a.%j.out 
#SBATCH --error=SIN_2a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 50 /home/emmanuel324/projects/belson324/belson324-opt  -i  SIN_2a.i
