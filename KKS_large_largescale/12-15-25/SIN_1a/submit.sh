#!/bin/bash                                                                     
#SBATCH --job-name=SIN_1a.i                                            
#SBATCH --output=SIN_1a.%j.out 
#SBATCH --error=SIN_1a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 30 /home/emmanuel324/projects/belson324/belson324-opt  -i  SIN_1a.i
