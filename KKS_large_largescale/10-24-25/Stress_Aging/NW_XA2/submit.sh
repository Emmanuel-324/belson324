#!/bin/bash                                                                     
#SBATCH --job-name=NW_XA2.i                                            
#SBATCH --output=NW_XA2.%j.out 
#SBATCH --error=NW_XA2.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 64 /home/emmanuel324/projects/belson324/belson324-opt  -i  NW_XA2.i
