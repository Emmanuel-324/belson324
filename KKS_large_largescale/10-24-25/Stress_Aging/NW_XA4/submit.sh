#!/bin/bash                                                                     
#SBATCH --job-name=NW_XA4.i                                            
#SBATCH --output=NW_XA4.%j.out 
#SBATCH --error=NW_XA4.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 64 /home/emmanuel324/projects/belson324/belson324-opt  -i  NW_XA4.i
