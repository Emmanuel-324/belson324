#!/bin/bash                                                                     
#SBATCH --job-name=NW_SF2.i                                            
#SBATCH --output=NW_SF2.%j.out 
#SBATCH --error=NW_SF2.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 50 /home/emmanuel324/projects/belson324/belson324-opt  -i  NW_SF2.i
