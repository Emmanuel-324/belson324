#!/bin/bash                                                                     
#SBATCH --job-name=NW_SF1.i                                            
#SBATCH --output=NW_SF1.%j.out 
#SBATCH --error=NW_SF1.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 64 /home/emmanuel324/projects/belson324/belson324-opt  -i  NW_SF1.i
