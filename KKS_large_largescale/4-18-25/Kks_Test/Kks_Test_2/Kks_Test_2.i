...
[Kernels]
  ...
  [./ACBulkF1]
    ...
    eta_i     = eta_pv1
    wi        = 0.01
    coupled_variables      = 'c1 c2 c3 eta_pv2 eta_m'
  [../]
  [./ACBulkC1]
  ...
  [./ACBulkF2]
    ...
    eta_i     = eta_pv2
    wi        = 0.01
    coupled_variables      = 'c1 c2 c3 eta_pv1 eta_m'
  [../]
  [./ACBulkC2]
    type = KKSMultiACBulkC
    variable  = eta_pv2
  ...
  # Kernels for Allen-Cahn equation for eta_m
  [./deta_mdt]
    type = TimeDerivative
    variable = eta_m
  [../]
  [./ACBulkFm]
    ...
    eta_i     = eta_m
    wi        = 0.01
    coupled_variables      = 'c1 c2 c3 eta_pv1 eta_pv2'
  [../]
  [./ACBulkCm]
    type = KKSMultiACBulkC
    variable  = eta_m
    ...
    cj_names  = 'c1 c2 c3'
    eta_i     = eta_m
    coupled_variables      = 'eta_pv1 eta_pv2'
  [../]
  [./ACInterfacem]
    type = ACInterface
    variable = eta_m
  ...
  # eta_m is the nonlinear variable for the constraint equation
 # [./eta_mreaction]
 #   type = MatReaction
  #  variable = eta_m
 #   reaction_rate = 1
