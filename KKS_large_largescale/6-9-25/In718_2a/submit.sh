#!/bin/bash                                                                     
#SBATCH --job-name=In718_2a.i                                            
#SBATCH --output=In718_2a.%j.out 
#SBATCH --error=In718_2a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 15 /home/emmanuel324/projects/belson324/belson324-opt  -i  In718_2a.i
