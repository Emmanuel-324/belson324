#!/bin/bash                                                                     
#SBATCH --job-name=In718_4.i                                            
#SBATCH --output=In718_4.%j.out 
#SBATCH --error=In718_4.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 15 /home/emmanuel324/projects/belson324/belson324-opt  -i  In718_4.i
