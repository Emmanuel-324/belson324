#!/bin/bash                                                                     
#SBATCH --job-name=In718_3a.i                                            
#SBATCH --output=In718_3a.%j.out 
#SBATCH --error=In718_3a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 8 /home/emmanuel324/projects/belson324/belson324-opt  -i  In718_3a.i
