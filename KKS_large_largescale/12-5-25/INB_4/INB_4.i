...
[Functions]
  ...
  [../]
   [./c2_gb_enrich_fn]
    ...
    symbol_values = '0.036   0.010     500.0   80.0'
  [../]
  [./misfit_c_fn]
    type  = ParsedFunction
...
[./hgpp2]
  ...
  # constant properties
   [./constants]
    ...
    prop_values = '0.00465   0.00465   0.00465   0.000465   3.87   7.74   7.74     7.74   46     1        0.01'
  [../]
   [./misfit_props]
  ...
  [./L_eta_d_mat]
    ...
    expression = 'L_d * ( gb_scale_aux + delta_time_ramp )'
...
[../]
  ...
  [./eigen_straind]
    type = ComputeRotatedEigenstrain
    base_name = phased
    eigen_base = '0.00532 0.01332 0 0 0 0'
    Euler_angles = '0 0 0'
    prefactor = misfit
