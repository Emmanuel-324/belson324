#!/bin/bash                                                                     
#SBATCH --job-name=INB_1.i                                            
#SBATCH --output=INB_1.%j.out 
#SBATCH --error=INB_1.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 50 /home/emmanuel324/projects/belson324/belson324-opt  -i  INB_1.i
