#!/bin/bash                                                                     
#SBATCH --job-name=INB_1a.i                                            
#SBATCH --output=INB_1a.%j.out 
#SBATCH --error=INB_1a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 50 /home/emmanuel324/projects/belson324/belson324-opt  -i  INB_1a.i
