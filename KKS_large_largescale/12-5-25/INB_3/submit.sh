#!/bin/bash                                                                     
#SBATCH --job-name=INB_3.i                                            
#SBATCH --output=INB_3.%j.out 
#SBATCH --error=INB_3.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 62 /home/emmanuel324/projects/belson324/belson324-opt  -i  INB_3.i
