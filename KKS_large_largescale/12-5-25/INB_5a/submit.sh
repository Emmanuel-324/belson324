#!/bin/bash                                                                     
#SBATCH --job-name=INB_5a.i                                            
#SBATCH --output=INB_5a.%j.out 
#SBATCH --error=INB_5a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 52 /home/emmanuel324/projects/belson324/belson324-opt  -i  INB_5a.i
