#!/bin/bash                                                                     
#SBATCH --job-name=INB_5.i                                            
#SBATCH --output=INB_5.%j.out 
#SBATCH --error=INB_5.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 62 /home/emmanuel324/projects/belson324/belson324-opt  -i  INB_5.i
