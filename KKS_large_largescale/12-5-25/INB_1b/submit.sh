#!/bin/bash
#SBATCH --job-name=INB_1b
#SBATCH --output=INB_1b.%j.out
#SBATCH --error=INB_1b.%j.err
...
srun --export=ALL --mpi=pmix /home/emmanuel324/projects/belson324/belson324-opt -i INB_1b.i
