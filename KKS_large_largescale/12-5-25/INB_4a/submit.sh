#!/bin/bash                                                                     
#SBATCH --job-name=INB_4a.i                                            
#SBATCH --output=INB_4a.%j.out 
#SBATCH --error=INB_4a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 62 /home/emmanuel324/projects/belson324/belson324-opt  -i  INB_4a.i
