...
[Materials]
  ...
  [./f_gammaP]
    ...
    expression =  '50.0*((c_Al_gammaP-0.00727)^2+2*(c_Nb_gammaP-0.196)^2)-2.0'
  [../]
 ...
 [./f_gammaDP]
  ...
  expression =  '50.0*((c_Al_gammaDP-0.187)^2+2*(c_Nb_gammaDP-0.000727)^2)'
[../]
 # Elastic energy of the phase 2
...
[../]
  ...
  [./constants]
    ...
    prop_names  = 'L0  L1  L2   kappa_c  D  misfit  W    kappa11 kappa12 kappa13 kappa21 kappa22 kappa23 kappa31 kappa32 kappa33  '
    prop_values = '0.3 0.3 0.3  0.01   1  0.000  0.01  0.75    0.75    0.75    0.75    0.75    0.75    0.75    0.75    0.75 '
  [../]
...
[Kernels]
  ...
  [./ACBulkF0]
    ...
    wi        = 0.01
    mob_name = L0
    args      = 'c_Al_gamma c_Nb_gamma c_Al_gammaP  c_Nb_gammaP c_Al_gammaDP c_Nb_gammaDP eta1  eta2'
  [../]
  ...
  [./ACBulkC0_Al]
    ...
    eta_i     = eta0
    mob_name = L0
    args      = 'c_Nb_gamma c_Nb_gammaP c_Nb_gammaDP eta1 eta2'
  [../]
  [./ACBulkC0_Nb]
    type = KKSMultiACBulkC
    variable  = eta0
    ...
    eta_i     = eta0
    mob_name = L0
    args      = 'c_Al_gamma c_Al_gammaP c_Al_gammaDP eta1 eta2'
  [../]
  [./ACInterface0]
