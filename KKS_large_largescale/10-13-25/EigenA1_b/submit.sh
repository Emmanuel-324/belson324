#!/bin/bash                                                                     
#SBATCH --job-name=EigenA1_b.i                                            
#SBATCH --output=EigenA1_b.%j.out 
#SBATCH --error=EigenA1_b.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 40 /home/emmanuel324/projects/belson324/belson324-opt  -i  EigenA1_b.i
