...
[Mesh]
  type = GeneratedMesh
  dim = 2
  nx = 350 # number of element in x direction
  ny = 350 # number of element in y direction
#  nz = 2
  xmin = 0
  xmax = 350
  ymin = 0
...
# Barrier functions for each phase
  ...
  [../]
   # Create a material property named "misfit_c" that equals the function misfit_c_fn
   [./misfit_c_prop]
    type       = GenericFunctionMaterial
    prop_names = 'misfit_c'
    prop_values = 'misfit_c'
  [../]

  # (optional) a-axis ramp, if you want it later
  # [./misfit_a_prop]
  #   type       = GenericFunctionMaterial
  #   prop_names = 'misfit_a'
  #   functions  = 'misfit_a_fn'
  # [../]
...
[Postprocessors]
  ...
  [./eta_pv1]
    type = ElementIntegralVariablePostprocessor_new1
    variable = eta_pv1
    low_threshold = 0.5
    high_threshold = 0.95
  [../]
