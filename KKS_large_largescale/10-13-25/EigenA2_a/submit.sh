#!/bin/bash                                                                     
#SBATCH --job-name=EigenA2_a.i                                            
#SBATCH --output=EigenA2_a.%j.out 
#SBATCH --error=EigenA2_a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 50 /home/emmanuel324/projects/belson324/belson324-opt  -i  EigenA2_a.i
