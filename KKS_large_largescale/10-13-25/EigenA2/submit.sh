#!/bin/bash                                                                     
#SBATCH --job-name=EigenA2.i                                            
#SBATCH --output=EigenA2.%j.out 
#SBATCH --error=EigenA2.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 60 /home/emmanuel324/projects/belson324/belson324-opt  -i  EigenA2.i
