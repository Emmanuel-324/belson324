#!/bin/bash                                                                     
#SBATCH --job-name=EigenA1.i                                            
#SBATCH --output=EigenA1.%j.out 
#SBATCH --error=EigenA1.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 50 /home/emmanuel324/projects/belson324/belson324-opt  -i  EigenA1.i
