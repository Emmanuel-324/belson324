#!/bin/bash                                                                     
#SBATCH --job-name=ES_03a.i                                            
#SBATCH --output=ES_03a.%j.out 
#SBATCH --error=ES_03a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 25 /home/emmanuel324/projects/belson324/belson324-opt  -i  ES_03a.i
