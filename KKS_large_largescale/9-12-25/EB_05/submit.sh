#!/bin/bash                                                                     
#SBATCH --job-name=EB_05.i                                            
#SBATCH --output=EB_05.%j.out 
#SBATCH --error=EB_05.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  EB_05.i
