...
ap.add_argument("--tau1", type=float, default=0.60, help="threshold for eta_pv1 (γʺ)")
ap.add_argument("--tau2", type=float, default=0.70, help="threshold for eta_pv2 (γʹ)")
ap.add_argument("--tau3", type=float, default=0.60, help="threshold for eta_pv3 (γʺ)")
...
root = args.root
out_path = args.out if args.out else (root / "summary_exclusive_seg.xlsx")
