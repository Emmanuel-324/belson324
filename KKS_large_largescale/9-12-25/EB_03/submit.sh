#!/bin/bash                                                                     
#SBATCH --job-name=EB_03.i                                            
#SBATCH --output=EB_03.%j.out 
#SBATCH --error=EB_03.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  EB_03.i
