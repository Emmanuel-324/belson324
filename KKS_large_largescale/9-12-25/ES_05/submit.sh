#!/bin/bash                                                                     
#SBATCH --job-name=ES_05.i                                            
#SBATCH --output=ES_05.%j.out 
#SBATCH --error=ES_05.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 25 /home/emmanuel324/projects/belson324/belson324-opt  -i  ES_05.i
