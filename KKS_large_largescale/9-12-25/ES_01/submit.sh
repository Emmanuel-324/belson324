#!/bin/bash                                                                     
#SBATCH --job-name=ES_01.i                                            
#SBATCH --output=ES_01.%j.out 
#SBATCH --error=ES_01.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  ES_01.i
