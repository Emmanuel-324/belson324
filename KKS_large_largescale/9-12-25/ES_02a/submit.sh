#!/bin/bash                                                                     
#SBATCH --job-name=ES_02a.i                                            
#SBATCH --output=ES_02a.%j.out 
#SBATCH --error=ES_02a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 25 /home/emmanuel324/projects/belson324/belson324-opt  -i  ES_02a.i
