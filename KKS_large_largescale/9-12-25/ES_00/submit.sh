#!/bin/bash                                                                     
#SBATCH --job-name=ES_00.i                                            
#SBATCH --output=ES_00.%j.out 
#SBATCH --error=ES_00.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  ES_00.i
