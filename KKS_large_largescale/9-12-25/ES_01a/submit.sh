#!/bin/bash                                                                     
#SBATCH --job-name=ES_01a.i                                            
#SBATCH --output=ES_01aa.%j.out 
#SBATCH --error=ES_01a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 25 /home/emmanuel324/projects/belson324/belson324-opt  -i  ES_01a.i
