#!/bin/bash                                                                     
#SBATCH --job-name=ES_02.i                                            
#SBATCH --output=ES_02.%j.out 
#SBATCH --error=ES_02.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 25 /home/emmanuel324/projects/belson324/belson324-opt  -i  ES_02.i
