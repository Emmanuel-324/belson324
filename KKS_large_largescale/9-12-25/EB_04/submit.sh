#!/bin/bash                                                                     
#SBATCH --job-name=EB_04.i                                            
#SBATCH --output=EB_04.%j.out 
#SBATCH --error=EB_04.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  EB_04.i
