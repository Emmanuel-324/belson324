#!/bin/bash                                                                     
#SBATCH --job-name=CS_2b.i                                            
#SBATCH --output=CS_2b.%j.out 
#SBATCH --error=CS_2b.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 35 /home/emmanuel324/projects/belson324/belson324-opt  -i  CS_2b.i
