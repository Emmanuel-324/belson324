#!/bin/bash                                                                     
#SBATCH --job-name=CS_2.i                                            
#SBATCH --output=CS_2.%j.out 
#SBATCH --error=CS_2.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 30 /home/emmanuel324/projects/belson324/belson324-opt  -i  CS_2.i
