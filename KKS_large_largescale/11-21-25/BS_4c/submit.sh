#!/bin/bash                                                                     
#SBATCH --job-name=BS_4c.i                                            
#SBATCH --output=BS_4c.%j.out 
#SBATCH --error=BS_4c.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 30 /home/emmanuel324/projects/belson324/belson324-opt  -i  BS_4c.i
