#!/bin/bash                                                                     
#SBATCH --job-name=BS_3b.i                                            
#SBATCH --output=BS_3b.%j.out 
#SBATCH --error=BS_3b.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 60 /home/emmanuel324/projects/belson324/belson324-opt  -i  BS_3b.i
