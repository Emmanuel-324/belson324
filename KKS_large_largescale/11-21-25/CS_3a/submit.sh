#!/bin/bash                                                                     
#SBATCH --job-name=CS_3a.i                                            
#SBATCH --output=CS_3a.%j.out 
#SBATCH --error=CS_3a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 40 /home/emmanuel324/projects/belson324/belson324-opt  -i  CS_3a.i
