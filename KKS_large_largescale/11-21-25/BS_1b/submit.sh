#!/bin/bash                                                                     
#SBATCH --job-name=BS_1b.i                                            
#SBATCH --output=BS_1b.i.%j.out 
#SBATCH --error=BS_1b.i.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 50 /home/emmanuel324/projects/belson324/belson324-opt  -i  BS_1b.i
