...
[./eta_d]
  type     = FunctionIC
  variable = eta_d
  function = '0.8 * 0.5*(tanh((x - 630.0)/1.0) - tanh((x - 650.0)/1.0))'
[../]
...
[Materials]
  # ------------------------------------------------------------------
# 1. Chemical free energy of matrix (γ) 
# ------------------------------------------------------------------
[./fc_gamma]
...
# ------------------------------------------------------------------
# 2. Chemical free energy of γ' (L12) 
# ------------------------------------------------------------------
[./fc_gp]
  type = DerivativeParsedMaterial
  property_name = fc_gp
...
[./hgpp2]
  ...
  type = DerivativeParsedMaterial
  coupled_variables = 'gb_scale_aux'
  material_property_names = 'L_d gate_2h'
  # L_eta_d = L_d * GB_boost * time_gate
  expression = 'L_d * gb_scale_aux * gate_2h'
