#!/bin/bash                                                                     
#SBATCH --job-name=BS_3.i                                            
#SBATCH --output=BS_3.%j.out 
#SBATCH --error=BS_3.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 50 /home/emmanuel324/projects/belson324/belson324-opt  -i  BS_3.i
