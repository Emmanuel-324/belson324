#!/bin/bash                                                                     
#SBATCH --job-name=CS_5.i                                            
#SBATCH --output=CS_5.%j.out 
#SBATCH --error=CS_5.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 30 /home/emmanuel324/projects/belson324/belson324-opt  -i  CS_5.i
