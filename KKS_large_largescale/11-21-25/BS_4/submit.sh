#!/bin/bash                                                                     
#SBATCH --job-name=BS_4.i                                            
#SBATCH --output=BS_4.%j.out 
#SBATCH --error=BS_4.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 50 /home/emmanuel324/projects/belson324/belson324-opt  -i  BS_4.i
