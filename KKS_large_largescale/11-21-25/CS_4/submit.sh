#!/bin/bash                                                                     
#SBATCH --job-name=CS_4.i                                            
#SBATCH --output=CS_4.%j.out 
#SBATCH --error=CS_4.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 30 /home/emmanuel324/projects/belson324/belson324-opt  -i  CS_4.i
