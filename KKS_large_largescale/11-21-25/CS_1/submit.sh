#!/bin/bash                                                                     
#SBATCH --job-name=CS_1.i                                            
#SBATCH --output=CS_1.%j.out 
#SBATCH --error=CS_1.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 30 /home/emmanuel324/projects/belson324/belson324-opt  -i  CS_1.i
