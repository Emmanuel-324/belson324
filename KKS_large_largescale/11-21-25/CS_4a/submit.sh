#!/bin/bash                                                                     
#SBATCH --job-name=CS_4a.i                                            
#SBATCH --output=CS_4a.%j.out 
#SBATCH --error=CS_4a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 35 /home/emmanuel324/projects/belson324/belson324-opt  -i  CS_4a.i
