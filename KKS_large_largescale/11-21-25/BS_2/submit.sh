#!/bin/bash                                                                     
#SBATCH --job-name=BS_2.i                                            
#SBATCH --output=BS_2.%j.out 
#SBATCH --error=BS_2.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 62 /home/emmanuel324/projects/belson324/belson324-opt  -i  BS_2.i
