#!/bin/bash                                                                     
#SBATCH --job-name=BS_2a.i                                            
#SBATCH --output=BS_2a.%j.out 
#SBATCH --error=BS_2a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 50 /home/emmanuel324/projects/belson324/belson324-opt  -i  BS_2a.i
