#!/bin/bash                                                                     
#SBATCH --job-name=BS_3a.i                                            
#SBATCH --output=BS_3a.%j.out 
#SBATCH --error=BS_3a.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 35 /home/emmanuel324/projects/belson324/belson324-opt  -i  BS_3a.i
