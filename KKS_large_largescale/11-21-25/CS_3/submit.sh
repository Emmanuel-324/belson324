#!/bin/bash                                                                     
#SBATCH --job-name=CS_3.i                                            
#SBATCH --output=CS_3.%j.out 
#SBATCH --error=CS_3.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 25 /home/emmanuel324/projects/belson324/belson324-opt  -i  CS_3.i
