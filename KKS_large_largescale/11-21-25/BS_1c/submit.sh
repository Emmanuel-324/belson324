#!/bin/bash                                                                     
#SBATCH --job-name=BS_1c.i                                            
#SBATCH --output=BS_1c.i.%j.out 
#SBATCH --error=BS_1c.i.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 24 /home/emmanuel324/projects/belson324/belson324-opt  -i  BS_1c.i
