#!/bin/bash                                                                     
#SBATCH --job-name=B1_Eu.i                                            
#SBATCH --output=B1_Eu.%j.out 
#SBATCH --error=B1_Eu.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  B1_Eu.i
