#!/bin/bash                                                                     
#SBATCH --job-name=S1_adapt.i                                            
#SBATCH --output=S1_adapt.%j.out 
#SBATCH --error=S1_adapt.%j.err       
#SBATCH --nodes=1                                                              
...
srun --export=ALL --mpi=pmi2 -n 16 /home/emmanuel324/projects/belson324/belson324-opt  -i  S1_adapt.i
